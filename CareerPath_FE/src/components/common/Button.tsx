...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:shadow-lg hover:shadow-blue-500/30 active:scale-95',
    secondary: 'bg-slate-100 text-slate-900 hover:bg-slate-200 active:scale-95',
    outline: 'border-2 border-slate-200 text-slate-700 hover:border-blue-500 hover:text-blue-600 active:scale-95',
